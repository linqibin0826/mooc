...
import com.linqibin.eduservice.service.*;
...
public class EduCourseServiceImpl extends ServiceImpl<EduCourseMapper, EduCourse> implements EduCourseService {
    ...
    @Override
    public List<EduCourse> getComputerList(String title) {
        // 根据学院的名称查询学院的id
        ...
        if (StringUtils.isEmpty(one)) {
            throw new MyException(ResultCode.ERROR,"学院名称不正确");
        }
        queryWrapper.eq("subject_parent_id", one.getId());
